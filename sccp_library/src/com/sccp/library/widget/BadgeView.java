...
public class BadgeView extends TextView {
    ...
    public void setDotStyle() {
    	...
    	setHideOnNull(false);
    	setTextSize(0);
        setPadding(dip2Px(dipRadius), dip2Px(dipRadius), dip2Px(dipRadius), dip2Px(dipRadius));
    }
    
    public void setDotStyle(int dipRadius) {
    	
    	if(dipRadius <= 0) {
    		dipRadius = 5;
    	}
    	else if (dipRadius >= 10) {
    		dipRadius = 10;
    	}
    	...
    	setTextSize(0);
        setPadding(dip2Px(dipRadius), dip2Px(dipRadius), dip2Px(dipRadius), dip2Px(dipRadius));
        setBackground(dipRadius, Color.parseColor("#d3321b"));
    }
