...
public class IndexManager {
  public enum Index {
    ...
    Index(String filename, Class<? extends IIndexReader> impl) {
    ...
    new Visitor() {
      ...
      @Override void visit(Index index, IIndexReader reader) throws IOException {
        ...
        try {
          ...
          if (indexFile.exists()) {
            Constructor<?> constructor = index.impl.getConstructor(File.class);
            reader = (IIndexReader) constructor.newInstance(indexFile);
