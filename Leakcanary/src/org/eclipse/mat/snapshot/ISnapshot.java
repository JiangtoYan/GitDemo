...
public interface ISnapshot {
   ...
   * @throws SnapshotException
   */
  Collection<IClass> getClassesByName(String name, boolean includeSubClasses)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  Collection<IClass> getClassesByName(Pattern namePattern, boolean includeSubClasses)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  int[] getInboundRefererIds(int[] objectIds, IProgressListener progressListener)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  int[] getOutboundReferentIds(int[] objectIds, IProgressListener progressListener)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  IPathsFromGCRootsComputer getPathsFromGCRoots(int objectId,
   ...
   * @throws SnapshotException
   */
  IMultiplePathsFromGCRootsComputer getMultiplePathsFromGCRoots(int[] objectIds,
                                                                Map<IClass, Set<String>> excludeMap) throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  int[] getRetainedSet(int[] objectIds, IProgressListener progressListener)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  int[] getRetainedSet(int[] objectIds, String[] fieldNames,
                       IProgressListener progressMonitor) throws SnapshotException;

  int[] getRetainedSet(int[] objectIds, ExcludedReferencesDescriptor[] excludedReferences,
                       IProgressListener progressMonitor) throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  int[] getMinRetainedSet(int[] objectIds, IProgressListener progressListener)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  long getMinRetainedSize(int[] objectIds, IProgressListener listener)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  DominatorsSummary getDominatorsOf(int[] objectIds, Pattern excludePattern,
   ...
   * @throws SnapshotException
   */
  int[] getTopAncestorsInDominatorTree(int[] objectIds, IProgressListener listener)
      throws SnapshotException;
   ...
   * @throws SnapshotException
   */
  int getHeapSize(int objectId) throws SnapshotException;
